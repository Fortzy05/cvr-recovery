...
export default function FooterSection() {
  return (
    <div className="w-full  font-serif bg-[#404040] py-10 text-white">
      <div className="container mx-auto flex flex-col md:flex-row md:justify-around items-center md:items-start px-6">
        {/* Contact Section */}
        <div className="mb-6 md:mb-0 text-center md:text-left">
          <h1 className="uppercase text-2xl font-bold mb-4">Our Contact</h1>
        ...
        {/* Services Section */}
        <div className="mb-6 md:mb-0 text-center md:text-left">
          <h1 className="uppercase text-2xl font-bold mb-4">Our Services</h1>
        ...
        <div className="text-center md:text-left">
          <h1 className="uppercase text-2xl font-bold mb-4">Our Address</h1>
          <div className="flex items-center justify-center md:justify-start gap-2">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              height="40"
