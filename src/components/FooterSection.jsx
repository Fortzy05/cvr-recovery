    ...
    <div className="w-full bg-[#404040] py-10 px-6 text-white">
      <div className="max-w-5xl mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-10 text-center md:text-left">
        ...
        <div className="flex flex-col items-center md:items-start">
          <h1 className="uppercase text-xl font-semibold mb-4">Our Contact</h1>
          <div className="space-y-3">
            ...
            <div className="flex items-center gap-2 hover:text-gray-300">
              ...
              <span className="text-sm sm:text-base">
                Autosaleslogisticsltd@gmail.com
              </span>
            </div>
            ...
            <div className="flex items-center gap-2 hover:text-gray-300">
              ...
              <span className="text-sm sm:text-base">+44 7407 207196</span>
            </div>
          </div>
        </div>
        ...
        {/* Services Section */}
        <div className="flex flex-col items-center md:items-start">
          <h1 className="uppercase text-xl font-semibold mb-4">Our Services</h1>
        ...
        {/* Address Section */}
        <div className="flex flex-col items-center md:items-start">
          <h1 className="uppercase text-xl font-semibold mb-4">Our Address</h1>
